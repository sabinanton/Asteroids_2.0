...
Earth = Celestial_bodies.Planet("Earth", 5.97219*10**23, 63710000, 147098070000, 0, 0, 30280)
Sun = Celestial_bodies.Planet("Sun", 1.989*10**30, 6963400000, 0, 0, 0, 0)
Mars = Celestial_bodies.Planet("Mars", 6.39*10**22, 33895000, 1.38*Constants.AU, 0, 0, 26500)
...
sim = Simulation_tools.Simulation([Earth, Sun, Mars],ast, 329945)
pygame.init()
...
while running :
    i+=1
    sim.simulate()
    x_offset = -Constants.scale * ast[4].pos_x
    y_offset = Constants.scale * ast[4].pos_y
